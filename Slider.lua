...
function Slider:findClosest(current)
...
function Slider:add(elem, selected)
...
function Slider:addButton(image, image_pushed, callback, selected)
...
function Slider:applyToAll(callback)
...
function Slider:jumptoItem(ind)
	if(self.conf.orientation == "horizontal") then
...
function Slider:firstItem()
	self:gotoItem(1)
end

function Slider:lastItem()
	self:gotoItem(self.total)
end